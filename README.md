...
> 💡 **더 깊이 있는 고민의 흔적들**
> 대용량 실시간 텔레메트리 처리 병목, 컨테이너 환경의 CORS, ML-Agents 좌표계 동기화 등 **개발 과정에서 직면한 6가지 핵심 트러블슈팅 과정**은 아래 문서에 상세히 기록해 두었습니다.
> 
> 👉 **[상세 트러블슈팅 문서(TROUBLESHOOTING.md) 보러 가기](./TROUBLESHOOTING.md)**
